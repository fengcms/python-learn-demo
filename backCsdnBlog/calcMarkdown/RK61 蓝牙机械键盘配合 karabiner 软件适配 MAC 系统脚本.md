...
lastmod: 2017-10-18 12:06:02 +0800
author: fungleo
preview: "RK61蓝牙机械键盘配合karabiner软件适配MAC系统脚本在mac升级到10.12之后，karabiner软件就一直在开发中。以至于我一直都没有使用这个软件来修改键盘映射。最近，我入手了一块RK61蓝牙机械键盘，准备用在mac笔记本上。但是默认的键盘布局让我十分恶心，主要是向上的方向键和斜线问号键是集成在一起的。而默认输入的是向上键。那么导致我们在正常操作中输入斜线"
tags: ["RK61", "蓝牙机械键盘", "mac", "karabiner"]
categories:
    - Tools
---
