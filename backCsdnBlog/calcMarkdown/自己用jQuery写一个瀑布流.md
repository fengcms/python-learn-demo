...
date: 2015-10-16 15:43:31 +0800
lastmod: 2015-10-16 15:43:31 +0800
author: fungleo
preview: "自己用jQuery写一个瀑布流前言这个月一直在忙工作。一直没有机会学习新的知识。前两天，突然想写一个瀑布流代码。倒不是找不到瀑布流代码。而是我想自己练练脑子。首先，先考虑思路。所有的图片，全部采用相对父目录定位的方式。然后用jQuery来找出它应该排在什么位置。最终，达成瀑布流的效果。想再多没用。开干。"
tags: ["jquery", "瀑布流", "javascript"]
categories:
    - jQuery
    - JavaScript
---
